...
```{r}
#Frequency table of categories mentioned by participants depending on vote
...
summary_stats <- participant_summary %>%
  summarise(mean_proportion_econ = mean(proportion_econ, na.rm = TRUE),
            median_proportion_econ = median(proportion_econ, na.rm = TRUE),
            sd_proportion_econ = sd(proportion_econ, na.rm = TRUE),
            mean_proportion_env = mean(proportion_env, na.rm = TRUE),
            median_proportion_env = median(proportion_env, na.rm = TRUE),
...
intended_vote_distribution <- participant_summary %>%
  group_by(intendedVote) %>%
  summarise(count = n(),
            proportion = count / nrow(participant_summary)) 
