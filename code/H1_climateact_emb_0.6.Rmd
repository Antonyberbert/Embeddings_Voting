...
combined_similarity_plot_facet <- ggplot(combined_similarity_data_facet, aes(x = entry, y = max_similarity, color = category)) +
  ...
  geom_text(data = medians_by_vote_and_category, aes(label = paste("Median:", round(median_value, 2)), y = median_value, color = category), 
            x = Inf, hjust = 1.1, vjust = 0, size = 3) + # x = Inf to align text to the right
  scale_color_manual(values = c("Economy" = "#56B4E9", "Environmental Protection" = "#E69F00")) +
...
# Save the plot
ggsave(here::here("plot","similarity_dis","similarity_dis","combined_similarity_plot_facet.png"), plot = combined_similarity_plot_facet, width = 10, height = 8, dpi = 300, bg = "transparent")
...
desc_across_vote_thresholds_econ <- ggplot(data, aes(x = Vote, y = Mean, fill = Category)) +
  ...
  labs(title = "Mean and SD of Economy Proportion, by Threshold and Intended Vote",
       x = "Condition by Threshold", y = "Mean Proportion") +
  theme_minimal() +
...
ggsave(here::here("plot","desc_across_vote_thresholds_econ.png"), plot = desc_across_vote_thresholds_econ, width = 10, height = 10, dpi = 300, bg = "transparent")
```
...
desc_across_vote_thresholds_env <- ggplot(data, aes(x = Vote, y = Mean, fill = Category)) +
  ...
  scale_fill_manual(values = colors) +
  facet_wrap(~Threshold, scales = "free_x", ncol = 3) +
  labs(title = "Mean and SD of Environmental Protection Proportion, by Threshold and Intended Vote",
       x = "Condition by Threshold", y = "Mean Proportion") +
  theme_minimal() +
  theme(legend.title = element_blank(), legend.position = "bottom", axis.text.x = element_text(angle = 45, hjust = 1))
...
ggsave(here::here("plot","desc_across_vote_thresholds_env.png"), plot = desc_across_vote_thresholds_env, width = 10, height = 10, dpi = 300, bg = "transparent")
```
...
ggsave(here::here("plot","env_subset_voters_barplot.png"), plot = env_subset_voters_barplot, width = 10, height = 8, dpi = 300, bg = "transparent")
```

```{r}
#Plot Mean and SD of Economy Proportion by Vote, Wave, and Threshold for All Participants
...
colors <- c("0.5_no" = "lightblue", "0.5_yes" = "lightcoral",
            "0.6_no" = "skyblue", "0.6_yes" = "salmon",
            "0.7_no" = "steelblue", "0.7_yes" = "darksalmon")
...
econ_wave_vote_threshold <- ggplot(data, aes(x = Type, y = Mean, fill = Group)) +
  ...
  scale_fill_manual(values = colors) +
  labs(title = "Mean and SD of Economy Proportion by Vote, Wave, and Threshold",
       x = "", y = "Mean Proportion") +
  theme_minimal() +
  theme(legend.title = element_blank(), legend.position = "bottom", axis.text.x = element_text(angle = 45, hjust = 1))
...
ggsave(here::here("plot","econ_wave_vote_threshold.png"), plot = econ_wave_vote_threshold, width = 10, height = 8, dpi = 300, bg = "transparent")
```
...
env_wave_vote_threshold <- ggplot(data, aes(x = Type, y = Mean, fill = Group)) +
  ...
  facet_wrap(~Threshold, scales = "free_x") +
  scale_fill_manual(values = colors) +
  labs(title = "Mean and SD of Environmental Protection Proportion by Vote, Wave, and Threshold",
       x = "", y = "Mean Proportion") +
  theme_minimal() +
  theme(legend.title = element_blank(), legend.position = "bottom", axis.text.x = element_text(angle = 45, hjust = 1))
...
ggsave(here::here("plot","env_wave_vote_threshold.png"), plot = env_wave_vote_threshold, width = 10, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave(here::here("plot","H1_0.6","vote_changes_dis.png"),vote_changes_dis, width = 10, height = 8, dpi = 300,bg="transparent")
```
