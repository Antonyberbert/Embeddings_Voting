...
packages <- c("devtools","here","dplyr","tidyverse","readxl","writexl","hunspell","text2vec","car","broom","lme4","RColorBrewer","rstatix","pROC")
...
energyact_fin <- energyact_fin %>%
  mutate(category = case_when(
    max_similarity_econ >= 0.5 & max_similarity_econ > max_similarity_env ~ "econ",
    max_similarity_env >= 0.5 & max_similarity_env > max_similarity_econ ~ "env",
    TRUE ~ "rest"
  ))
```
...
#Save the econ plot
ggsave(here::here("plot","H1_0.5","diff_cons_all_econ.png"), diff_cons_all_econ, width = 10, height = 8, dpi = 300,bg="transparent")
...
#Save the env plot
ggsave(here::here("plot","H1_0.5","diff_cons_all_env.png"), diff_cons_all_env, width = 10, height = 8, dpi = 300,bg="transparent")
```
...
ggsave(here::here("plot","H1_0.5","econ_subset_voters_barplot.png"), plot = econ_subset_voters_barplot, width = 10, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave(here::here("plot","H1_0.5","env_subset_voters_barplot.png"), plot = env_subset_voters_barplot, width = 10, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave(here::here("plot","H1_0.5","vote_changes_dis.png"),vote_changes_dis, width = 10, height = 8, dpi = 300,bg="transparent")
```
...
ggsave(here::here("plot","H1_0.5","mean_econ_vote_all.png"), mean_econ_vote_all, width = 10, height = 8, dpi = 300,bg="transparent")

# Plot for env - all participants
mean_env_vote_all <- plot_by_intendedVote(energyact_fin_summary, "env")
ggsave(here::here("plot","H1_0.5","mean_env_vote_all.png"), mean_env_vote_all, width = 10, height = 8, dpi = 300,bg="transparent")

# Plot for econ - consistent participants
mean_econ_vote_cons <- plot_by_intendedVote(energyact_fin_summary_cons, "econ")
ggsave(here::here("plot","H1_0.5","mean_econ_vote_cons.png"), mean_econ_vote_cons, width = 10, height = 8, dpi = 300,bg="transparent")

# Plot for env - consistent participants
mean_env_votet_cons <- plot_by_intendedVote(energyact_fin_summary_cons, "env")
ggsave(here::here("plot","H1_0.5","mean_env_vote_cons.png"), mean_env_votet_cons, width = 10, height = 8, dpi = 300,bg="transparent")
```
...
# Save the Econ plot
ggsave(here::here("plot","H1_0.5","mean_econ_wave_all.png"), mean_econ_wave_all, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","mean_env_wave_all.png"), mean_env_wave_all, width = 10, height = 8, dpi = 300)
```
...
# Save the Econ plot
ggsave(here::here("plot","H1_0.5","mean_econ_wave_cons.png"), mean_econ_wave_cons, width = 10, height = 8, dpi = 300)
...
# Save the Env plot to the 'plot' directory with the name 'env_plot.png'
ggsave(here::here("plot","H1_0.5","mean_env_wave_cons.png"), mean_env_wave_cons, width = 10, height = 8, dpi = 300)
```
...
ggsave(here::here("plot","H1_0.5","mean_env_wave_vote_all.png"), mean_env_wave_vote_all, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","mean_econ_wave_vote_all.png"), mean_econ_wave_vote_all, width = 10, height = 8, dpi = 300)
```
...
ggsave(here::here("plot","H1_0.5","mean_env_wave_vote_cons.png"), mean_env_wave_vote_cons, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","mean_econ_wave_vote_cons.png"), mean_econ_wave_vote_cons, width = 10, height = 8, dpi = 300)
```
...
```{r}
# Wilcoxon signed-rank test for proportions overall
...
ggsave(here::here("plot","H1_0.5","paired_wilcox_across_env.png"), paired_wilcox_across_env, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","paired_wilcox_across_econ.png"), paired_wilcox_across_econ, width = 10, height = 8, dpi = 300)
```
...
ggsave(here::here("plot","H1_0.5","paired_wilcox_no_env.png"), paired_wilcox_no_env, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","paired_wilcox_yes_env.png"), paired_wilcox_yes_env, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","paired_wilcox_no_econ.png"), paired_wilcox_no_econ, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","paired_wilcox_yes_econ.png"), paired_wilcox_yes_econ, width = 10, height = 8, dpi = 300)
```
...
#econ
wilcox.test(proportions_both_vote_wave$econ[proportions_both_vote_wave$intendedVote==0],proportions_both_vote_wave$econ[proportions_both_vote_wave$intendedVote==1],alternative="greater")
#env
wilcox.test(proportions_both_vote_wave$env[proportions_both_vote_wave$intendedVote==1],proportions_both_vote_wave$env[proportions_both_vote_wave$intendedVote==0],alternative="greater")
...
#econ t1
wilcox.test(data_t1_all$econ[data_t1_all$intendedVote==0],data_t1_all$econ[data_t1_all$intendedVote==1],alternative="greater")

#env t1
wilcox.test(data_t1_all$env[data_t1_all$intendedVote==1],data_t1_all$env[data_t1_all$intendedVote==0],alternative="greater")

# Wilcoxon Rank Sum Test for t2
#econ t2
wilcox.test(data_t2_all$econ[data_t2_all$intendedVote==0],data_t2_all$econ[data_t2_all$intendedVote==1],alternative="greater")

#env t2
wilcox.test(data_t2_all$env[data_t2_all$intendedVote==1],data_t2_all$env[data_t2_all$intendedVote==0],alternative="greater")
...
ggsave(here::here("plot","H1_0.5","between_wilcox_env_across.png"), between_wilcox_env_across, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","between_wilcox_env_t1.png"), between_wilcox_env_t1, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","between_wilcox_env_t2.png"), between_wilcox_env_t2, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","between_wilcox_econ_across.png"), between_wilcox_econ_across, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","between_wilcox_econ_t1.png"), between_wilcox_econ_t1, width = 10, height = 8, dpi = 300)
...
ggsave(here::here("plot","H1_0.5","between_wilcox_econ_t2.png"), between_wilcox_econ_t2, width = 10, height = 8, dpi = 300)
```
...
# Plot the ROC curve
auc_plot_0.5 <- plot(roc_curve, main="ROC Curve")
