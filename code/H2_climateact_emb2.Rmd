...
ggsave("similarity_plots_grid_1.png", grid_1, width = 16, height = 12)
ggsave("similarity_plots_grid_2.png", grid_2, width = 16, height = 12)
```
```{r}
...
# Save the grids to PNG files
ggsave("similarity_plots_grid1.png", grid1, width = 20, height = 10)
ggsave("similarity_plots_grid2.png", grid2, width = 20, height = 10)
```
```{r}
# Assuming energyact_fin_long and medians_by_vote are already prepared
# Calculate median similarity scores for each category by intendedVote
